...
def get_trip_ids_for_stop_new(
    ...
    potential_trips = stop_times[mask_1 & mask_2][
...
def stop_times_for_kth_trip(
    ...
    potential_trips = get_trip_ids_for_stop_new(
